...
const  beansPage = async () => {
   ...
   const PizzaRecipe = await fetchBeans("https://forkify-api.herokuapp.com/api/v2/recipes?search=pizza&key=93838a86-f043-44b3-b7cf-0e86da1d4167", {
      cache: "no-store",
   });

   const beansRecipe = await fetchBeans("https://forkify-api.herokuapp.com/api/v2/recipes?search=beans&key=93838a86-f043-44b3-b7cf-0e86da1d4167", {
      cache: "no-store",
   });
   
   const fishRecipe = await fetchBeans("https://forkify-api.herokuapp.com/api/v2/recipes?search=fish&key=93838a86-f043-44b3-b7cf-0e86da1d4167", {
      cache: "no-store",
   });
   
   const teaRecipe = await fetchBeans("https://forkify-api.herokuapp.com/api/v2/recipes?search=tea&key=93838a86-f043-44b3-b7cf-0e86da1d4167", {
      cache: "no-store",
   });
